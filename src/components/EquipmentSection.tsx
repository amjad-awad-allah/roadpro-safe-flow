...
const equipment = [
  {
    ...
    specs: [
      "NCHRP 350 TL-3 Compliant",
      "High-visibility LED arrow board",
  ...
  },
  {
    ...
    specs: [
      "Reflective collars for high visibility",
      "PVC & rubber construction",
...
const EquipmentSection = () => {
  ...
  return (
    <section id="equipment" className="section-padding bg-roadpro-lightgray">
            ...
            >
              <div className="md:w-2/5 overflow-hidden">
                <img 
                  ...
                  style={{ height: "100%", minHeight: "200px", objectFit: "cover" }}
                />
              </div>
