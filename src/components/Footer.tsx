        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <p className="text-gray-300 mb-6">
              Leading provider of traffic management and road safety solutions in Abu Dhabi and across the UAE.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <a href="#clients" className="text-gray-300 hover:text-roadpro-yellow transition-colors">Our Clients</a>
              </li>
              <li>
                <a href="#advantages" className="text-gray-300 hover:text-roadpro-yellow transition-colors">Why Choose Us</a>
              </li>
              <li>
                <a href="#sustainability" className="text-gray-300 hover:text-roadpro-yellow transition-colors">Sustainability</a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <a href="#" className="text-gray-300 hover:text-roadpro-yellow transition-colors">Traffic Diversion</a>
              </li>
              <li>
                <a href="#" className="text-gray-300 hover:text-roadpro-yellow transition-colors">Lane Closure Equipment</a>
              </li>
              <li>
                <a href="#" className="text-gray-300 hover:text-roadpro-yellow transition-colors">Street Closure Management</a>
              </li>
              <li>
                <a href="#" className="text-gray-300 hover:text-roadpro-yellow transition-colors">Safety Equipment (TMA)</a>
              </li>
              <li>
                <a href="#" className="text-gray-300 hover:text-roadpro-yellow transition-colors">Traffic Consultancy</a>
              </li>
              <li>
                <a href="#" className="text-gray-300 hover:text-roadpro-yellow transition-colors">Safety Training</a>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-white/10 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              &copy; {new Date().getFullYear()} RoadPro Safety & Traffic Management. All rights reserved.
            </p>
