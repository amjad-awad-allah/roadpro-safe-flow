    ...
    <section id="clients" className="section-padding bg-roadpro-black text-white">
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {clients.map((client, index) => <div key={index} className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl border border-white/10 hover:border-roadpro-yellow transition-all duration-300 shadow-lg hover:shadow-roadpro-yellow/30 hover:scale-105 group" tabIndex={0}>
        ...
        <div className="mt-16 p-8 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/10 shadow-lg text-center max-w-3xl mx-auto">
          <h3 className="text-2xl font-bold mb-4 font-poppins">Partner With Us </h3>
